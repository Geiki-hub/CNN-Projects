...
best_model_path = os.path.join(checkpoint_dir, "64 Adam ResNet50 (Epoch 200).h5")
...
np.savez_compressed(
    "ResNet50_test_predictions.npz",
    y_true=y_true,
    y_probs=y_probs,
    filenames=test_generator.filenames[: len(y_probs)],
)
print("Saved predictions to 'ResNet50_test_predictions.npz'")

# Default operational cutoff
tau = 0.5
