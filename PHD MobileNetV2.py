...
model_checkpoint = ModelCheckpoint(r'C:\Users\kikit\OneDrive\Documents\UNIMAP PHD\2. TRIAL DATASET SPLIT\64 Adam MobileNetV2 (Epoch 200).h5', save_best_only=True, monitor='val_loss', mode='min', verbose=1)
...
# Confusion Matrix
cm = confusion_matrix(Y_test_actual_hot, Y_test_pred_hot)
